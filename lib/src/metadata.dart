class LinkAccountMetadata {
  ...
  /// The account verification status. Can be one of the following values:
  ...
  String description() {
    return "[id: $id, mask: $mask, name: $name, type: $type, subtype: $subtype, verificationStatus $verificationStatus]]";
  }
}
